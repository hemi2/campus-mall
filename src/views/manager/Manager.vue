    ...
    <el-container>
      ...
      <el-aside :width="asideWidth" style="min-height: 100vh; background-color: #001529">
        <div style="height: 60px; color: white; display: flex; align-items: center; justify-content: center">
          ...
          <span class="logo-title" v-show="!isCollapse">校园商城后台</span>
        </div>
        ...
        <el-menu :default-openeds="['info']" :collapse="isCollapse" :collapse-transition="false" router background-color="#001529" text-color="rgba(255, 255, 255, 0.65)"
          ...
          <el-submenu index="info" >
            ...
            <el-menu-item index="/type" v-if="role === 'admin'">商品分类</el-menu-item>
            <el-menu-item index="/goods" v-if="role === 'admin'">商品信息</el-menu-item>
            <el-menu-item index="/orderList" v-if="role === 'admin'">订单管理</el-menu-item>
          </el-submenu>
          <el-submenu index="user" >
            ...
            <el-menu-item index="/user" v-if="role === 'admin'">用户信息</el-menu-item>
          </el-submenu>
        </el-menu>
